...
namespace phoneContactWithJSON.Services
{
    ...
    {
        private IJSONServices jsonService;
        private ILoggingServices loggingServices;
        private List<PhoneContact> phoneContacts;

        public ContactServices()
        {
            this.jsonService = new JSONServices();
            this.loggingServices = new LoggingServices();
            this.phoneContacts = jsonService.ReadContacts();
        }
        ...
        public void AddContact()
        {
            ...
            while (!isAdded)
            {
                try
                {
                    ...
                    jsonService.AddContact(newContact);
        ...
        public void EditContact()
        {
            ...
            try
            {
                ...
                if (index > 0 && index <= phoneContacts.Count)
                {
                    ...
                    jsonService.SaveAllContacts(phoneContacts);
